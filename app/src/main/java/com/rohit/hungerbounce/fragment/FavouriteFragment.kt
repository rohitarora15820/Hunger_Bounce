...
class FavouriteFragment : Fragment() {
    ...
    private val restaurantsInfoList= arrayListOf<Restaurants>()
    ...
    private fun setUpRecycler(view: View) {
        ...
        * Here we can reuse the adapter created for the home fragment. This will save our time and optimize our app as well*/
        ...
        if (backgroundList.isEmpty()) {
            ...
            allRestaurantsAdapter = HomeRecyclerAdapter(restaurantsInfoList, activity as Context)
